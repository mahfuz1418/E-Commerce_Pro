                    ...
                    <ul class="navbar-nav w-100">
                        <li class="nav-item w-100">
                            <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="POST"
                                action="{{ route('search') }}">
                                @csrf
                                <input type="text" class="form-control text-light" placeholder="Search Here"
                                    name="search">
                                <input type="submit" value="Search" class="btn btn-outline-info ml-2">
                            </form>
                        </li>
                    </ul>
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <form action="{{ route('logout') }}" method="post">
                                    ...
                                    <a class="dropdown-item preview-item">
                                        ...
                                        <div class="preview-item-content">
                                            <button class="preview-subject mb-1 btn p-0">Log out</button>
                                        </div>
                                    </a>
                                </form>
                                <div class="dropdown-divider"></div>
                                                ...
                                                <tr class="text-center text-light">
                                                    ...
                                                    <td>
                                                        @if ($order->delevery_status == 'Processing')
                                                            <a href="{{ route('delivered.product', $order->id) }}"
                                                                class="btn btn-primary"
                                                                onclick="return confirm('Are You sure your product delivered!!')">Delivered</a>
                                                        @elseif($order->delevery_status == 'Order Canceled')
                                                            <p class="text-danger">Canceled</p>
                                                        @elseif($order->delevery_status == 'Delivered')
                                                            <p class="text-success">Delivered</p>
                                                        @endif

                                                    </td>
                                                    <td>
                                                        <a href="{{ route('get.pdf', $order->id) }}"
                                                            class="btn btn-info">Print Pdf</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('send.email', $order->id) }}"
                                                            class="btn btn-warning">Send Mail</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>

                                                    <td colspan="16" class="text-center text-danger">No order placed
                                                        yet</td>
