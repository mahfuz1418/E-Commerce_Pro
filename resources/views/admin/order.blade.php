                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul class="navbar-nav w-100">
                        <li class="nav-item w-100">
                            <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="POST" action="{{ route('search') }}">
                                @csrf
                                <input type="text" class="form-control text-light" placeholder="Search Here" name="search">
                                        ...
                                        <tbody>
                                            @forelse ($orders as $order)
                                                <tr class="text-center text-light" >
                                                    ...
                                                    <td>
                                                        <a href="{{ route('get.pdf', $order->id) }}" class="btn btn-info">Print Pdf</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('send.email', $order->id) }}" class="btn btn-warning">Send Mail</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>

                                                    <td colspan="16" class="text-center text-danger">No order placed yet</td>
